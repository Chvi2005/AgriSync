    ...
    <div class="row g-3 mb-4">
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm rounded-3 h-100 p-3 bg-white border-start border-primary border-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <span class="text-muted extra-small text-uppercase fw-semibold d-block">Registered Farmers</span>
                        <h3 class="fw-bold text-dark mb-0 mt-1" id="metricFarmers">--</h3>
                    </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm rounded-3 h-100 p-3 bg-white border-start border-success border-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <span class="text-muted extra-small text-uppercase fw-semibold d-block">Business Buyers</span>
                        <h3 class="fw-bold text-dark mb-0 mt-1" id="metricBusiness">--</h3>
                    </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm rounded-3 h-100 p-3 bg-white border-start border-info border-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <span class="text-muted extra-small text-uppercase fw-semibold d-block">Total Listed Yield (kg)</span>
                        <h3 class="fw-bold text-dark mb-0 mt-1" id="metricVolumeKg">-- kg</h3>
                    </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm rounded-3 h-100 p-3 bg-white border-start border-warning border-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <span class="text-muted extra-small text-uppercase fw-semibold d-block">Fulfilled Trade Value</span>
                        <h3 class="fw-bold text-dark mb-0 mt-1" id="metricTradeValue">Rs. 0.00</h3>
                    </div>
